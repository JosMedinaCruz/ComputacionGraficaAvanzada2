...
std::string fileNames[6] = {
		"../Textures/mp_forest/forest_rt.tga",
		"../Textures/mp_forest/forest_lf.tga",
		"../Textures/mp_forest/forest_up.tga",
		"../Textures/mp_forest/forest_dn.tga",
		"../Textures/mp_forest/forest_ft.tga",
		"../Textures/mp_forest/forest_bk.tga",
};
...
void applicationLoop() {
	...
	//cowboy
	modelMatrixCowboy = glm::translate(modelMatrixCowboy, glm::vec3(20.0f, 0.05f, -5.0f));
	modelMatrixCowboy = glm::scale(modelMatrixCowboy, glm::vec3(0.05f, 0.05f, 0.05f));
	modelMatrixCowboy = glm::rotate(modelMatrixCowboy, glm::radians(-90.0f), glm::vec3(0, 1, 0));

	modelMatrixCyborg = glm::translate(modelMatrixCyborg, glm::vec3(5.0f, 0.05f, -5.0f));
	modelMatrixCyborg = glm::rotate(modelMatrixCyborg, glm::radians(-90.0f), glm::vec3(0, 1, 0));
	...
	while (psi) {
		...
		modelMatrixCowboyBody = glm::scale(modelMatrixCowboyBody, glm::vec3(0.021, 0.021, 0.021));
		...
		modelMatrixCyborgBody = glm::scale(modelMatrixCyborgBody, glm::vec3(0.021, 0.021, 0.021));
		cyborgModelAnimate.setAnimationIndex(0);
