...
std::string fileName = "";
bool record = false;
// Variable para guardar el número de angulos rotados por el vehículo
...
std::vector<glm::vec3> lamp2Position = { glm::vec3(-36.52, 0, -23.24), //Lamp2
			glm::vec3(-52.73, 0, -3.90), glm::vec3(-33.59, 0, -41.01),
			glm::vec3(-64.84, 0, -53.71), glm::vec3(-54.10, 0, -74.40) };
std::vector<float> lamp2Orientation = { 21.37 + 90, -65.0, 41.33 - 180, 43.26, 43.26 - 180 };

std::vector<glm::vec3> lamp3Position = { glm::vec3(-46.17, 0, 17.18) };
std::vector<float> lamp3Orientation = { -39.71 };
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	//Lamp 3
	modelLamp3.loadModel("../models/Streetlamp/street lamp.obj");
...
bool processInput(bool continueApplication) {
	...
	if (modelSelected == 3 && glfwGetKey(window, GLFW_KEY_LEFT) == GLFW_PRESS) {
		angleRotation += 1.0;
		modelMatrixLambo = rotate(modelMatrixLambo, radians(1.0f), glm::vec3(0, 1, 0));
	...
	if (modelSelected == 3 && glfwGetKey(window, GLFW_KEY_UP) == GLFW_PRESS) {
		modelMatrixLambo = translate(modelMatrixLambo, glm::vec3(0.0, 0.0, 0.02));
	}
...
void applicationLoop() {
	...
	while (psi) {
		...
		/*******************************************
		 * Propiedades Luz SpotLight Terrain
		 *******************************************/
		...
		shaderMulLighting.setFloat("spotLights[0].cutOff", cos(glm::radians(8.5f)));
		shaderMulLighting.setFloat("spotLights[0].outerCutOff", cos(glm::radians(12.5f)));
		...
		shaderTerrain.setFloat("spotLights[0].cutOff", cos(glm::radians(8.5f)));
		shaderTerrain.setFloat("spotLights[0].outerCutOff", cos(glm::radians(12.5f)));



		glm::vec3 spotPositionLambo1 = modelMatrixLambo * glm::vec4(1.3, 5.3, 0.6, 1.0f);
		shaderMulLighting.setVectorFloat3("spotLights[1].light.ambient", glm::value_ptr(glm::vec3(0.0, 0.0, 0.0)));
		shaderMulLighting.setVectorFloat3("spotLights[1].light.diffuse", glm::value_ptr(glm::vec3(0.2, 0.2, 0.2)));
		shaderMulLighting.setVectorFloat3("spotLights[1].light.specular", glm::value_ptr(glm::vec3(0.3, 0.3, 0.3)));
		shaderMulLighting.setVectorFloat3("spotLights[1].position", glm::value_ptr(glm::vec3(spotPositionLambo1)));
		shaderMulLighting.setVectorFloat3("spotLights[1].direction", glm::value_ptr(vec3(sin((radians(angleRotation))), -1, cos((radians(angleRotation))))));
		shaderMulLighting.setFloat("spotLights[1].constant", 1.0);
		shaderMulLighting.setFloat("spotLights[1].linear", 0.0014);
		shaderMulLighting.setFloat("spotLights[1].quadratic", 0.0001);
		...
		shaderTerrain.setVectorFloat3("spotLights[1].light.diffuse", glm::value_ptr(glm::vec3(0.2, 0.2, 0.2)));
		shaderTerrain.setVectorFloat3("spotLights[1].light.specular", glm::value_ptr(glm::vec3(0.3, 0.3, 0.3)));
		shaderTerrain.setVectorFloat3("spotLights[1].position", glm::value_ptr(glm::vec3(spotPositionLambo1)));
		shaderTerrain.setVectorFloat3("spotLights[1].direction", glm::value_ptr(vec3(sin((radians(angleRotation))), -1, cos((radians(angleRotation))))));
		shaderTerrain.setFloat("spotLights[1].constant", 1.0);
		shaderTerrain.setFloat("spotLights[1].linear", 0.0014);
		shaderTerrain.setFloat("spotLights[1].quadratic", 0.0001);
		...
		glm::vec3 spotPositionLambo2 = modelMatrixLambo * glm::vec4(-1.3, 5.3, 0.6, 1.0f);
		shaderMulLighting.setVectorFloat3("spotLights[2].light.ambient", glm::value_ptr(glm::vec3(0.0, 0.0, 0.0)));
		shaderMulLighting.setVectorFloat3("spotLights[2].light.diffuse", glm::value_ptr(glm::vec3(0.2, 0.2, 0.2)));
		shaderMulLighting.setVectorFloat3("spotLights[2].light.specular", glm::value_ptr(glm::vec3(0.3, 0.3, 0.3)));
		shaderMulLighting.setVectorFloat3("spotLights[2].position", glm::value_ptr(glm::vec3(spotPositionLambo2)));
		shaderMulLighting.setVectorFloat3("spotLights[2].direction", glm::value_ptr(vec3(sin((radians(angleRotation))), -1, cos((radians(angleRotation))))));
		shaderMulLighting.setFloat("spotLights[2].constant", 1.0);
		shaderMulLighting.setFloat("spotLights[2].linear", 0.0014);
		shaderMulLighting.setFloat("spotLights[2].quadratic", 0.0001);
		shaderMulLighting.setFloat("spotLights[2].cutOff", cos(glm::radians(12.5f)));
		shaderMulLighting.setFloat("spotLights[2].outerCutOff", cos(glm::radians(12.5f)));
		shaderTerrain.setVectorFloat3("spotLights[2].light.ambient", glm::value_ptr(glm::vec3(0.0, 0.0, 0.0)));
		shaderTerrain.setVectorFloat3("spotLights[2].light.diffuse", glm::value_ptr(glm::vec3(0.2, 0.2, 0.2)));
		shaderTerrain.setVectorFloat3("spotLights[2].light.specular", glm::value_ptr(glm::vec3(0.3, 0.3, 0.3)));
		shaderTerrain.setVectorFloat3("spotLights[2].position", glm::value_ptr(glm::vec3(spotPositionLambo2)));
		shaderTerrain.setVectorFloat3("spotLights[2].direction", glm::value_ptr(vec3(sin((radians(angleRotation))), -1, cos((radians(angleRotation))))));
		shaderTerrain.setFloat("spotLights[2].constant", 1.0);
		shaderTerrain.setFloat("spotLights[2].linear", 0.0014);
		shaderTerrain.setFloat("spotLights[2].quadratic", 0.0001);
		shaderTerrain.setFloat("spotLights[2].cutOff", cos(glm::radians(12.5f)));
		shaderTerrain.setFloat("spotLights[2].outerCutOff", cos(glm::radians(12.5f)));
		...
		for (int i = 0; i < lamp1Position.size(); i++) {
			...
			shaderMulLighting.setFloat("pointLights[" + std::to_string(i) + "].linear", 0.01);
			...
			shaderTerrain.setFloat("pointLights[" + std::to_string(i) + "].linear", 0.01);
		...
		for (int i = 0; i < lamp2Position.size(); i++) {
			...
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0.76455f, 4.994f, 0.0));
			glm::vec3 lampPosition = matrixAdjustLamp[3];
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.02)));//RGB
			...
			shaderMulLighting.setFloat("pointLights[" + std::to_string(lamp1Position.size() + i) + "].linear", 0.01);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(lamp1Position.size() + i) + "].quadratic", 0.01);
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.02)));//RGB
			...
			shaderTerrain.setFloat("pointLights[" + std::to_string(lamp1Position.size() + i) + "].linear", 0.01);
		...
		for (int i = 0; i < lamp3Position.size(); i++) {
			...
			matrixAdjustLamp = glm::scale(matrixAdjustLamp, glm::vec3(1.0f, 1.0f, 1.0f));
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0.006449f, 1.26729f, 0.0));
			glm::vec3 lampPosition = matrixAdjustLamp[3];
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.02)));//RGB
			...
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.5, 0.02)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].position", glm::value_ptr(glm::vec3(lampPosition)));
			shaderMulLighting.setFloat("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].constant", 1.0);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].linear", 0.01);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].quadratic", 0.01);
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].light.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.02)));//RGB
			...
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].light.specular", glm::value_ptr(glm::vec3(0.6, 0.5, 0.02)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].position", glm::value_ptr(glm::vec3(lampPosition)));
			shaderTerrain.setFloat("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].constant", 1.0);
			shaderTerrain.setFloat("pointLights[" + std::to_string(lamp1Position.size() + lamp2Position.size() + i) + "].linear", 0.01);
		...
		for (int i = 0; i < lamp3Position.size(); i++) {
			...
			modelLamp3.setScale(glm::vec3(1.7, 1.7, 1.4));
			modelLamp2.setOrientation(glm::vec3(0, lamp3Orientation[i], 0));
			modelLamp3.render();
		}
