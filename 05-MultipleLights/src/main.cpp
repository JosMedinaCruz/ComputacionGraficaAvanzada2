...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	modelLamp2.loadModel("../models/Street_Light/objLamp.obj");
...
void applicationLoop() {
	...
	while (psi) {
		 ...
		 *******************************************/
		glm::vec3 spotPosition = modelMatrixHeli * glm::vec4(0.0f, 0.30f, 2.04f, 1.0f); //Para que al moverse el helicóptero también se mueva la luz
		shaderMulLighting.setInt("spotLightCount", 1); //De multipleLights.fs
		shaderTerrain.setInt("spotLightCount", 1); //Cambiar en multipleLights.fs y terrain.fs de 1  a 5 en la línea 40
		...
		shaderMulLighting.setFloat("spotLights[0].outerCutOff", cos(glm::radians(16.5f)));
		...
		shaderTerrain.setFloat("spotLights[0].linear", 0.014);//0.0014
		shaderTerrain.setFloat("spotLights[0].quadratic", 0.007);//0.01
		shaderTerrain.setFloat("spotLights[0].cutOff", cos(glm::radians(12.5f)));
		shaderTerrain.setFloat("spotLights[0].outerCutOff", cos(glm::radians(16.5f)));
		...
		for (int i = 0; i < lamp2Position.size(); i++) { //Practica 5
			...
			matrixAdjustLamp = glm::translate(matrixAdjustLamp, glm::vec3(0.76f, 4.994f, 0.0f));
			glm::vec3 lampPosition = matrixAdjustLamp[3];
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].ligth.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.01))); //rgb
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].ligth.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderMulLighting.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].ligth.specular", glm::value_ptr(glm::vec3(0.6, 0.5, 0.02)));
			...
			shaderMulLighting.setFloat("pointLights[" + std::to_string(lamp1Position.size() + i) + "].linear", 0.005);
			shaderMulLighting.setFloat("pointLights[" + std::to_string(lamp1Position.size() + i) + "].quadratic", 0.005);

			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].ligth.ambient", glm::value_ptr(glm::vec3(0.2, 0.16, 0.01))); //rgb
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].ligth.diffuse", glm::value_ptr(glm::vec3(0.4, 0.32, 0.02)));
			shaderTerrain.setVectorFloat3("pointLights[" + std::to_string(lamp1Position.size() + i) + "].ligth.specular", glm::value_ptr(glm::vec3(0.6, 0.5, 0.02)));
			...
			shaderTerrain.setFloat("pointLights[" + std::to_string(lamp1Position.size() + i) + "].linear", 0.005);
			shaderTerrain.setFloat("pointLights[" + std::to_string(lamp1Position.size() + i) + "].quadratic", 0.005);
		...
		for (int i = 0; i < lamp2Position.size(); i++) {
			...
			modelLampPost2.setOrientation(glm::vec3(0.0, lamp2Orientation[i], 0.0));
