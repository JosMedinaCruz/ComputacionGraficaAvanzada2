...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	shaderMulLighting.initialize("../Shaders/iluminacion_textura_animation_fog.vs", "../Shaders/multipleLights_fog.fs"); //fog
	shaderTerrain.initialize("../Shaders/terrain_fog.vs", "../Shaders/terrain_fog.fs"); // en Shaders / iluminacion_textura_animation_fog.vs y multipleLights_fog.fs
...
void applicationLoop() {
	...
	while (psi) {
		...
		/*******************************************
		* Propiedades de la neblina (fog)
		*********************************/
		shaderMulLighting.setVectorFloat3("fogColor", glm::value_ptr(glm::vec3(0.0, 0.0, 0.5)));
		shaderMulLighting.setFloat("density", 0.04);
		shaderTerrain.setVectorFloat3("fogColor", glm::value_ptr(glm::vec3(0.0, 0.0, 0.5)));
		shaderTerrain.setFloat("density", 0.04);
		shaderSkybox.setVectorFloat3("fogColor",glm::value_ptr(glm::vec3(0.0, 0.0, 0.5)));
