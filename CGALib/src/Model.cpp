...
void Model::loadModel(const std::string & path) {
	...
	/*this->sbb.ratio = sqrt(    //Se comentó para optimizarlo la parte de la esfera
	...
	float disx = fabs(this->aabb.mins.x - this->aabb.maxs.x); //distancias entre el minimo y el maximo en los ejes
