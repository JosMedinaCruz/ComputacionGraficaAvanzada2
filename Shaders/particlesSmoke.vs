...
vec3 randomInitialVelocity() { // Comportamiento circular para el humo 
    float theta = mix(0.0, PI / 1.5, texelFetch(RandomTex, 3 * gl_VertexID, 0).r); //mix interpola entre 2 valores
